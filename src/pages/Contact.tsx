        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          ...
          >
            <p className="text-xl font-medium leading-relaxed text-black/80 mb-12">
              ...
              Our team is always looking for new collaborations and creative challenges.
            </p>
            
            <div className="space-y-8">
              <div>
                <p className="text-[10px] font-bold tracking-[0.4em] uppercase opacity-40 mb-2">Email</p>
                <a href="mailto:hello@dirtcakestudio.com" className="text-2xl font-display font-black hover:text-neon-blue transition-colors">
                  hello@dirtcakestudio.com
                </a>
              </div>
              <div>
                <p className="text-[10px] font-bold tracking-[0.4em] uppercase opacity-40 mb-2">Location</p>
          ...
          >
            {isSubmitted ? (
              <div className="h-full flex flex-col items-center justify-center text-center p-12 bg-black text-white rounded-3xl shadow-2xl">
                ...
                <h3 className="font-display text-4xl font-black uppercase mb-4">Message Sent!</h3>
                <p className="opacity-70 font-bold tracking-tight">We'll get back to you as soon as possible.</p>
                <button 
              ...
              <form onSubmit={handleSubmit} className="space-y-10">
                <div className="group">
                  <label className="text-[10px] font-bold tracking-[0.4em] uppercase opacity-40 group-focus-within:opacity-100 group-focus-within:text-neon-blue transition-all">Name</label>
                  <input 
                    type="text" 
                    required
                ...
                <div className="group">
                  <label className="text-[10px] font-bold tracking-[0.4em] uppercase opacity-40 group-focus-within:opacity-100 group-focus-within:text-neon-pink transition-all">Email</label>
                  <input 
                    type="email" 
                    required
                ...
                <div className="group">
                  <label className="text-[10px] font-bold tracking-[0.4em] uppercase opacity-40 group-focus-within:opacity-100 group-focus-within:text-neon-green transition-all">Message</label>
                  <textarea 
                    required
                    rows={4}
